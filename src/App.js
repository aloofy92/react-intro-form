...
const DATA_URL = "https://github.com/dd-code-immersives/movie-project/blob/main/react-intro-form/data/movies.json"
...
const removeableMovies  = (index) => {
       
            const moviesTOFilter = movies.filter((_, i) => {
                return i !== index
            })
    ...
    <div className='App'>
       <h1>Movie Form</h1>
        ...
        removeableMovies = {removeableMovies} />
        <Search movieData ={movies} searchHandle = {searchHandle} changeHandle = {changeHandle}/>
